...
export type TeleporterTargetComponentProps =
  React.ComponentPropsWithRef<"div"> & {
    "data-portkey": string;
  };

export type TeleporterTargetProps<T = TeleporterTargetComponentProps> =
  React.PropsWithChildren<
    Omit<TeleporterTargetComponentProps, "data-portkey"> & {
